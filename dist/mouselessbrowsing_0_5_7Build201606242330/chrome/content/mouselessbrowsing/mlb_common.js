...
(function(){
	var MlbCommon = { 
		...
		MLB_VERSION: "0.5.6Build201310302030",
      ...
      MLB_BINDING_KEY_ATTR: "mlb_binding_key",
		...
		init: function(){
         ...
         try{
            ...
            this.scriptLoader.loadScript(this.COMMON_CHROME_ULR+"firefox/Application.js", namespaceObj)
            var exclude = ["Shortcutmanager.js", "ObjectUtils.js", "Application.js"]
